...
namespace MiniSoftware.Drawing.Metafile.Emf.Records.DrawingRecordTypes
{
    ...
    internal class EMR_ALPHABLEND : Record
    {
        ...
        public EMR_ALPHABLEND()
        {
            Header = new RecordHeader { Type = RecordType.EMR_ALPHABLEND };
        }
        ...
        public override void Write(BinaryWriter writer)
        {
            ...
            writer.Write(CxDest);
            writer.Write(CyDest);
            writer.Write(BlendOperation);
            writer.Write(XSrc);
            writer.Write(YSrc);
            XFormSrc.Write(writer);
            writer.Write(ColorAdjust);
