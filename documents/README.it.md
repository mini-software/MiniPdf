...
L'output di MiniPdf viene confrontato con LibreOffice come renderer di riferimento su **150 casi di test classici** (inclusi 30 casi con immagini incorporate, 30 casi con grafici e 30 casi di stile).
...
**Punteggio medio complessivo: 97.1%** (similarità testo 40% + similarità visiva 40% + conteggio pagine 20%)
