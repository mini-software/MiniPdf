...
La sortie de MiniPdf est comparée à LibreOffice comme moteur de rendu de référence sur **150 cas de test classiques** (dont 30 cas d'images intégrées, 30 cas de graphiques et 30 cas de style).
...
**Score moyen global : 97.1%** (similarité textuelle 40% + similarité visuelle 40% + nombre de pages 20%)
