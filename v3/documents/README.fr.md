...
La sortie DOCX de MiniPdf est comparée à LibreOffice comme moteur de rendu de référence sur **120 cas de test classiques**.
...
**Score moyen global : 97.0%** (similarité textuelle 40% + similarité visuelle 40% + nombre de pages 20%)
