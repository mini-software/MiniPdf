...
L'output DOCX di MiniPdf viene confrontato con LibreOffice come renderer di riferimento su **120 casi di test classici**.
...
**Punteggio medio complessivo: 97.0%** (similarità testo 40% + similarità visiva 40% + conteggio pagine 20%)
